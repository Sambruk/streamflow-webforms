      ...
      extends ServiceComposite, Activatable
{
         ...
         implements Activatable
   {
      ...
      private void exportConfigurableServices() throws NotCompliantMBeanException, MBeanRegistrationException, InstanceAlreadyExistsException, MalformedObjectNameException, UnitOfWorkCompletionException, InstantiationException
      {
         for (ServiceReference<Configuration> configurableService : configurableServices)
         {
            ...
            // Ensure that this configuration exists
            configurableService.get().configuration();
